...
$$
La diffusion de la chaleur correspond donc à une descente de gradient de l'entropie dans l'espace de Wasserstein. Le flux de chaleur est donc le chemin le plus court (géodésique) pour dissiper l'énergie libre. 

Comme cette EDP est souvent difficile à résoudre directement, on utilise en pratique le schéma de Jordan-Kinderlehrer-Otto (JKO).
